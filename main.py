...
for x in range(0,len(l1)):
    l2.append(0)                                                #all element of l2 becomes 0 till length of l1
                       ...
                       # TESTING DATA
test=pd.read_csv("https://raw.githubusercontent.com/Mayank8279/Disease-Prediction/main/testing.csv")              #reading csv file by pd
...
# TRAINING DATA
train=pd.read_csv("https://raw.githubusercontent.com/Mayank8279/Disease-Prediction/main/training.csv")
...
mayankGUI = Tk()
mayankGUI.title(" Disease Prediction Based on Symptoms")
mayankGUI.configure()
...
S1En = OptionMenu(mayankGUI, Symptom1, *OPTIONS)
S1En.grid(row=7, column=2)

S2En = OptionMenu(mayankGUI, Symptom2, *OPTIONS)
S2En.grid(row=8, column=2)

S3En = OptionMenu(mayankGUI, Symptom3, *OPTIONS)
S3En.grid(row=9, column=2)

S4En = OptionMenu(mayankGUI, Symptom4, *OPTIONS)
S4En.grid(row=10, column=2)

S5En = OptionMenu(mayankGUI, Symptom5, *OPTIONS)
S5En.grid(row=11, column=2)

NameLb = Label(mayankGUI, text="")
...
t3 = Text(mayankGUI, height=2, width=30, bg="grey")
